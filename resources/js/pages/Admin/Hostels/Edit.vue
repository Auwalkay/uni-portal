...
import { 
    ...
    Users, UserCheck, Eye, EyeOff, ShieldCheck, Home
                        ...
                        <div class="bg-card border rounded-3xl p-6 shadow-sm space-y-6 sticky top-8">
                            ...
                            <div class="space-y-3 pt-2">
                                ...
                                >
                                    ...
                                    {{ form.processing ? 'Updating Hostel...' : 'Update Hostel' }}
                                </Button>

                                <Button type="button" variant="outline" as-child class="w-full h-12 rounded-2xl font-bold text-sm">
                                    <Link :href="route('admin.hostels.show', hostel.id)">Cancel & Return</Link>
                                </Button>
                            </div>
                        </div>
                    </div>
