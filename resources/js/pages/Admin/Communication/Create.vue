...
import { Megaphone, ArrowLeft, Upload, FileText, X, CheckCircle } from 'lucide-vue-next';
import WysiwygEditor from '@/components/WysiwygEditor.vue';

const breadcrumbs: BreadcrumbItem[] = [
    { title: 'Dashboard', href: '/admin/dashboard' },
    { title: 'Announcements', href: '/admin/announcements' },
    { title: 'New', href: '/admin/announcements/create' },
];
        ...
        <div class="flex-1 space-y-6 p-6">
            ...
            <div class="flex items-center gap-4 border-b pb-4">
                ...
                <div>
                    ...
                    <p class="text-muted-foreground mt-0.5">Create a rich text notice or upload a scanned document/memo.</p>
                </div>
            </div>
            ...
            <div class="grid gap-6 lg:grid-cols-3">
                ...
                <div class="space-y-6">
                    ...
                    <Card class="bg-card border-border shadow-sm">
                        ...
                        <CardContent class="space-y-4">
                            <p class="text-xs text-muted-foreground">Optional. Upload a scanned memo or PDF file instead of typing the content.</p>
